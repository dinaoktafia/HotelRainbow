                  ...
                  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="assets/gambar/g1.jpeg" height="450">
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="card">
              <div class="col-md-12">
                <div class="card-body">
                  ...
                  <p class="text-center">Terinspirasi oleh sejuknya suasana alam yang ada di Nusantara dan mewahnya fasilitas Hotel. Dengan menyatukan elemen-elemen tersebut, maka terciptalah sebuah hotel berkelas dan nyaman. Semua ada di Hotel Rainbow, hotel yang menghadap langsung ke lautan luas seakan memberikan pengalaman yang indah untuk Anda dan keluarga Anda. Semua kemewahan dan kenyamanan itu bisa Anda dapatkan sekaligus di Hotel Rainbow.</p>
                </div>
              </div>
            </div>          
          </div><!-- /.container-fluid -->
