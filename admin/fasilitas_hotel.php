                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="edit_fasilitas_hotel.php?id=<?php echo $row['id']; ?>" class="btn btn btn-warning">Edit</a>
                          <a href="hapus_fasilitas_hotel.php?id=<?php echo $row['id']; ?>" class="btn btn btn-danger" onclick="return confirm('Anda yakin akan menghapus data ini...?')">Hapus</a>
                        </td>
                      </tr>
                      <?php $no++; } ?>
                    </tbody>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="tambah_fasilitas_hotel.php" enctype="multipart/form-data">
