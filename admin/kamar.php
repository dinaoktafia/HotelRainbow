                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="edit_kamar.php?kode_kamar=<?php echo $row['kode_kamar']; ?>" class="btn btn btn-warning">Edit</a>
                          <a href="hapus_kamar.php?kode_kamar=<?php echo $row['kode_kamar']; ?>" class="btn btn btn-danger" onclick="return confirm('Anda yakin akan menghapus data ini...?')">Hapus</a>
                        </td>
                      </tr>
                      <?php $no++; } ?>
                    </tbody>
