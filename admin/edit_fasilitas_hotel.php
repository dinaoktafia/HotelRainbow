...
if (isset($_GET['id'])) {
  ...
  if (!count($data)) {
    echo "<script>alert('Data tidak ditemukan di database');window.location='fasilitas_hotel.php';</script>";
  }
} else {
  echo "<script>alert('Masukan Data');window.location='fasilitas_hotel.php';</script>";
}
