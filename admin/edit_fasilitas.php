...
if (isset($_GET['id'])) {
  $id_kamar = ($_GET['id']);
  $query = "SELECT * FROM tipe_kamar WHERE id='$id_kamar'";
          ...
          <div class="col-md-12">
            <div class="card card-outline card-info">
              <div class="card-header">
                <h3>Edit Data fasilitas Kamar</h3>
              </div>
              <div class="card-body">
                <form method="post" action="update_fasilitas.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input name="fasilitas" value="<?php echo $data['fasilitas']; ?>" hidden>
                    <input type="text" class="form-control" value="<?php echo $data['fasilitas']; ?>" name="fasilitas" placeholder="Fasilitas">
                  </div>
                  <div class="form-group">
                    <label>Jumlah Kamar</label>
                    <input name="jumlah_kamar" value="<?php echo $data['jumlah_kamar']; ?>" hidden>
